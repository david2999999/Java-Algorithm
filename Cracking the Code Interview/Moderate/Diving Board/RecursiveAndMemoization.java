...
public class RecursiveAndMemoization {
    private HashSet<Integer> allLengths(int k, int shorter, int longer) {
    ...
    private void getAllLengths(int k, int total, int shorter,
                               int longer, HashSet<Integer> lengths, HashSet<String> visited) {
        if (k == 0) {
            lengths.add(total);
            return;
        }
